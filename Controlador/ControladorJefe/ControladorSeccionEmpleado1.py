import sys
from PyQt6.QtWidgets import QApplication, QDialog, QLineEdit, QLabel, QVBoxLayout, QPushButton
...
class ControladorSeccionEmpleado:
    ...
    def __init__(self, estilo):
        ...
        self.__window.get_boton_eliminar().clicked.connect(self.__window.mostrar_ventana_eliminar_empleado)
    ...
    def obtener_empleados(self):
        SeccionEmpleadoVista.set_tabla_datos(self.__base.getAll("SELECT dni_usuario, nombre_usuario, nombre, apellido FROM public.usuario"))
    ...
    def eliminar_empleado(self):
        ...
        if texto_buscado:
            self.__base.query("DELETE FROM public.usuario WHERE dni_usuario LIKE '%{}%'".format(texto_buscado))
