...
class RepeatedBackgroundWidget(QWidget):
    def __init__(self):
        ...
        self.background_image = QPixmap("C:/Users/LENOVO/Desktop/SGBD_TF_POO-vj_se_ver1/Vista/Media/shelter-icon.png")
...
class Login (QMainWindow):
    ...
    def generar_interfaz(self):
        ...
        logo.setPixmap(QPixmap('C:/Users/LENOVO/Desktop/SGBD_TF_POO-vj_se_ver1/Vista/Media/logo-bsf.png').scaled(logo.width(),logo.height()))
