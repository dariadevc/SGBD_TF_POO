...
class EncabezadoVistaJefe(
    ...
    def __init__(self):
        ...
        # barra_nav | botones
        boton_seccion_empleado = BotonNavegador(
            "Empleados", "Vista/Media/icon-empleado.png"
        )
        boton_seccion_animales = BotonNavegador(
            "Animales", "Vista/Media/icon-animales.png"
        )
        boton_seccion_clientes = BotonNavegador(
            "Clientes", "Vista/Media/icon-cliente.png"
        )
        ...
        self.componer_layout(
            barra_nav_layout,
            [
                boton_seccion_empleado,
                boton_seccion_animales,
                boton_seccion_clientes,
                boton_seccion_citas,
            ],
        )
...
class SeccionEmpleadoVista(QMainWindow):
    ...
    def __init__(self):
        ...
        self.componer_layout(
            acciones_botones_layout, [agregar_e, modificar_e, eliminar_e]
        )
        ...
        tabla_datos.setHorizontalHeaderLabels(
