...
class EncabezadoVista(
    QVBoxLayout
):  # encabezado común para todas las vistas de VistaJefe
    def __init__(self):
        super().__init__()
        ...
        # banner | logo
        logo = QPixmap(
            "C:/Users/Fiore/OneDrive/Escritorio/SGBD_TF_POO/Vista/Media/logo-bsf.png"
        )
        ...
        ruedita_png = QPixmap(
            "C:/Users/Fiore/OneDrive/Escritorio/SGBD_TF_POO/Vista/Media/configuration-wheel-svgrepo-com.png"
        )
        ...
        banner_layout.addStretch(
            1
        )  # <-- añade un espacio elastico entre los elementos entre los que esté puesto, puede haber más de un addStretch para generar espacios de distintos tamaños
        banner_layout.addLayout(usuario_layout)

        # barra_nav | botones
        # boton_seccion_empleado = BotonNavegador("Empleados", "Vista/Media/icon-empleado.png")
        self.boton_seccion_informes = BotonNavegador(
            "Informes", "Vista/Media/informe-icon.png"
        )
        self.boton_seccion_empleados = BotonNavegador(
            "Empleados", "Vista/Media/icon-empleado.png"
        )
        self.boton_seccion_animales = BotonNavegador(
            "Animales",
            "C:/Users/Fiore/OneDrive/Escritorio/SGBD_TF_POO/Vista/Media/icon-animales.png",
        )
        self.boton_seccion_adopcion = BotonNavegador(
            "Adopciones",
            "C:/Users/Fiore/OneDrive/Escritorio/SGBD_TF_POO/Vista/Media/icon-adopciones-2.png",
        )
        self.boton_seccion_adoptantes = BotonNavegador(
            "Adoptantes",
            "C:/Users/Fiore/OneDrive/Escritorio/SGBD_TF_POO/Vista/Media/icon-adoptantes.png",
        )
        self.boton_seccion_visitas = BotonNavegador(
            "Visitas",
            "C:/Users/Fiore/OneDrive/Escritorio/SGBD_TF_POO/Vista/Media/icon-citas.png",
        )
        self.boton_seccion_visitantes = BotonNavegador(
            "Visitantes",
            "C:/Users/Fiore/OneDrive/Escritorio/SGBD_TF_POO/Vista/Media/icon-visitantes.png",
        )
        ...
        self.componer_layout(
            barra_nav_layout,
            [
                self.boton_seccion_informes,
                self.boton_seccion_empleados,
                self.boton_seccion_animales,
                self.boton_seccion_adopcion,
                self.boton_seccion_adoptantes,
                self.boton_seccion_visitas,
                self.boton_seccion_visitantes,
            ],
        )
